...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  Future<void> _loadActiveShift() async {
    ...
    if (activeShift != null) {
      ...
      final scheduleTime = DateTime(now.year, now.month, now.day, 22, 0); // Jam 22:00
      if (now.isBefore(scheduleTime)) {
        await NotificationManager.getInstance().showScheduleNotification(
          ...
          channelDescription: "Mengingatkan untuk mematikan stopwatch absensi kerja",
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: "Contoh: Sisa cup 30 pcs, mesin espresso sudah dibersihkan.",
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            // Profil Pengguna Aktif (Lock Session)
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      _isShiftActive
                          ? "Shift Sedang Berjalan (Jam Masuk: ${timeFormatter.format(_startTime!)})"
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        height: 50,
                        child: ElevatedButton(
                          onPressed: _isShiftActive ? _showStopShiftDialog : _startShift,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: _isShiftActive ? Colors.redAccent : primaryColor,
                            shape: RoundedRectangleBorder(
